...
static bool ElfPerformRelocations(void* data, size_t relocation_point, struct rel_table** table) {
    struct Elf32_Ehdr* elf_header = (struct Elf32_Ehdr*) data;
	struct Elf32_Shdr* sect_headers = (struct Elf32_Shdr*) AddVoidPtr(data, elf_header->e_shoff);
...
static int ElfLoad(void* data, size_t* relocation_point, struct file* file, struct rel_table** table, bool driver) {
