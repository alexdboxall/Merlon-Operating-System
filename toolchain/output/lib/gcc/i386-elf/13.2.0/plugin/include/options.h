...
enum opt_code
{
  ...
  OPT_march_ = 1913,                         /* -march= */
  OPT_masm_ = 1914,                          /* -masm= */
  OPT_mavx = 1915,                           /* -mavx */
  OPT_mavx2 = 1916,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1917,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1918,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1919,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1920,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1921,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1922,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1923,                      /* -mavx512bw */
  OPT_mavx512cd = 1924,                      /* -mavx512cd */
  OPT_mavx512dq = 1925,                      /* -mavx512dq */
  OPT_mavx512er = 1926,                      /* -mavx512er */
  OPT_mavx512f = 1927,                       /* -mavx512f */
  OPT_mavx512fp16 = 1928,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 1929,                    /* -mavx512ifma */
  OPT_mavx512pf = 1930,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1931,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1932,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1933,                      /* -mavx512vl */
  OPT_mavx512vnni = 1934,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1935,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1936,               /* -mavx512vpopcntdq */
  OPT_mavxifma = 1937,                       /* -mavxifma */
  OPT_mavxneconvert = 1938,                  /* -mavxneconvert */
  OPT_mavxvnni = 1939,                       /* -mavxvnni */
  OPT_mavxvnniint8 = 1940,                   /* -mavxvnniint8 */
  OPT_mbmi = 1941,                           /* -mbmi */
  OPT_mbmi2 = 1942,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1943,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1944,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1945,                    /* -mcet-switch */
  OPT_mcld = 1946,                           /* -mcld */
  OPT_mcldemote = 1947,                      /* -mcldemote */
  OPT_mclflushopt = 1948,                    /* -mclflushopt */
  OPT_mclwb = 1949,                          /* -mclwb */
  OPT_mclzero = 1950,                        /* -mclzero */
  OPT_mcmodel_ = 1951,                       /* -mcmodel= */
  OPT_mcmpccxadd = 1952,                     /* -mcmpccxadd */
  /* OPT_mcpu_ = 1953, */                    /* -mcpu= */
  OPT_mcrc32 = 1954,                         /* -mcrc32 */
  OPT_mcx16 = 1955,                          /* -mcx16 */
  OPT_mdaz_ftz = 1956,                       /* -mdaz-ftz */
  OPT_mdirect_extern_access = 1957,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 1958,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1959,            /* -mdump-tune-features */
  OPT_menqcmd = 1960,                        /* -menqcmd */
  OPT_mf16c = 1961,                          /* -mf16c */
  OPT_mfancy_math_387 = 1962,                /* -mfancy-math-387 */
  OPT_mfentry = 1963,                        /* -mfentry */
  OPT_mfentry_name_ = 1964,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1965,               /* -mfentry-section= */
  OPT_mfma = 1966,                           /* -mfma */
  OPT_mfma4 = 1967,                          /* -mfma4 */
  OPT_mforce_drap = 1968,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1969,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1970,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1971,                       /* -mfpmath= */
  OPT_mfsgsbase = 1972,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1973,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1974, */              /* -mfused-madd */
  OPT_mfxsr = 1975,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1976,             /* -mgeneral-regs-only */
  OPT_mgfni = 1977,                          /* -mgfni */
  OPT_mhard_float = 1978,                    /* -mhard-float */
  OPT_mharden_sls_ = 1979,                   /* -mharden-sls= */
  OPT_mhle = 1980,                           /* -mhle */
  OPT_mhreset = 1981,                        /* -mhreset */
  OPT_miamcu = 1982,                         /* -miamcu */
  OPT_mieee_fp = 1983,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1984,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1985,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1986,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1987,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1988,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1989,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1990,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1991, */            /* -mintel-syntax */
  OPT_mkl = 1992,                            /* -mkl */
  OPT_mlam_ = 1993,                          /* -mlam= */
  OPT_mlarge_data_threshold_ = 1994,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1995,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1996,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1997,                /* -mlong-double-80 */
  OPT_mlwp = 1998,                           /* -mlwp */
  OPT_mlzcnt = 1999,                         /* -mlzcnt */
  OPT_mmanual_endbr = 2000,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 2001,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 2002,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 2003,                  /* -mmitigate-rop */
  OPT_mmmx = 2004,                           /* -mmmx */
  OPT_mmovbe = 2005,                         /* -mmovbe */
  OPT_mmovdir64b = 2006,                     /* -mmovdir64b */
  OPT_mmovdiri = 2007,                       /* -mmovdiri */
  OPT_mmove_max_ = 2008,                     /* -mmove-max= */
  OPT_mmpx = 2009,                           /* -mmpx */
  OPT_mms_bitfields = 2010,                  /* -mms-bitfields */
  OPT_mmwait = 2011,                         /* -mmwait */
  OPT_mmwaitx = 2012,                        /* -mmwaitx */
  OPT_mneeded = 2013,                        /* -mneeded */
  OPT_mno_align_stringops = 2014,            /* -mno-align-stringops */
  OPT_mno_default = 2015,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 2016,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 2017,                  /* -mno-push-args */
  OPT_mno_red_zone = 2018,                   /* -mno-red-zone */
  OPT_mno_sse4 = 2019,                       /* -mno-sse4 */
  OPT_mnop_mcount = 2020,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 2021,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 2022,                          /* -mpc32 */
  OPT_mpc64 = 2023,                          /* -mpc64 */
  OPT_mpc80 = 2024,                          /* -mpc80 */
  OPT_mpclmul = 2025,                        /* -mpclmul */
  OPT_mpcommit = 2026,                       /* -mpcommit */
  OPT_mpconfig = 2027,                       /* -mpconfig */
  OPT_mpku = 2028,                           /* -mpku */
  OPT_mpopcnt = 2029,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 2030, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 2031,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 2032,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchi = 2033,                     /* -mprefetchi */
  OPT_mprefetchwt1 = 2034,                   /* -mprefetchwt1 */
  OPT_mprfchw = 2035,                        /* -mprfchw */
  OPT_mptwrite = 2036,                       /* -mptwrite */
  OPT_mpush_args = 2037,                     /* -mpush-args */
  OPT_mraoint = 2038,                        /* -mraoint */
  OPT_mrdpid = 2039,                         /* -mrdpid */
  OPT_mrdrnd = 2040,                         /* -mrdrnd */
  OPT_mrdseed = 2041,                        /* -mrdseed */
  OPT_mrecip = 2042,                         /* -mrecip */
  OPT_mrecip_ = 2043,                        /* -mrecip= */
  OPT_mrecord_mcount = 2044,                 /* -mrecord-mcount */
  OPT_mrecord_return = 2045,                 /* -mrecord-return */
  OPT_mred_zone = 2046,                      /* -mred-zone */
  OPT_mregparm_ = 2047,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 2048,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 2049,                           /* -mrtd */
  OPT_mrtm = 2050,                           /* -mrtm */
  OPT_msahf = 2051,                          /* -msahf */
  OPT_mserialize = 2052,                     /* -mserialize */
  OPT_msgx = 2053,                           /* -msgx */
  OPT_msha = 2054,                           /* -msha */
  OPT_mshstk = 2055,                         /* -mshstk */
  OPT_mskip_rax_setup = 2056,                /* -mskip-rax-setup */
  OPT_msoft_float = 2057,                    /* -msoft-float */
  OPT_msse = 2058,                           /* -msse */
  OPT_msse2 = 2059,                          /* -msse2 */
  OPT_msse2avx = 2060,                       /* -msse2avx */
  OPT_msse3 = 2061,                          /* -msse3 */
  OPT_msse4 = 2062,                          /* -msse4 */
  OPT_msse4_1 = 2063,                        /* -msse4.1 */
  OPT_msse4_2 = 2064,                        /* -msse4.2 */
  OPT_msse4a = 2065,                         /* -msse4a */
  /* OPT_msse5 = 2066, */                    /* -msse5 */
  OPT_msseregparm = 2067,                    /* -msseregparm */
  OPT_mssse3 = 2068,                         /* -mssse3 */
  OPT_mstack_arg_probe = 2069,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 2070, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2071,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 2072, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 2073,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 2074,                  /* -mstackrealign */
  OPT_mstore_max_ = 2075,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 2076,            /* -mstringop-strategy= */
  OPT_mstv = 2077,                           /* -mstv */
  OPT_mtbm = 2078,                           /* -mtbm */
  OPT_mtls_dialect_ = 2079,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 2080,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 2081,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 2082,                    /* -mtune-ctrl= */
  OPT_mtune_ = 2083,                         /* -mtune= */
  OPT_muintr = 2084,                         /* -muintr */
  OPT_munroll_only_small_loops = 2085,       /* -munroll-only-small-loops */
  OPT_mvaes = 2086,                          /* -mvaes */
  OPT_mveclibabi_ = 2087,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2088,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2089,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2090,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2091,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2092,                      /* -mwbnoinvd */
  OPT_mwidekl = 2093,                        /* -mwidekl */
  OPT_mx32 = 2094,                           /* -mx32 */
  OPT_mxop = 2095,                           /* -mxop */
  OPT_mxsave = 2096,                         /* -mxsave */
  OPT_mxsavec = 2097,                        /* -mxsavec */
  OPT_mxsaveopt = 2098,                      /* -mxsaveopt */
  OPT_mxsaves = 2099,                        /* -mxsaves */
  OPT_n = 2100,                              /* -n */
  ...
  OPT_nophoboslib = 2108,                    /* -nophoboslib */
  OPT_nostartfiles = 2109,                   /* -nostartfiles */
  OPT_nostdinc = 2110,                       /* -nostdinc */
  OPT_nostdinc__ = 2111,                     /* -nostdinc++ */
  OPT_nostdlib = 2112,                       /* -nostdlib */
  OPT_nostdlib__ = 2113,                     /* -nostdlib++ */
  OPT_o = 2114,                              /* -o */
  OPT_objects = 2115,                        /* -objects */
  OPT_p = 2116,                              /* -p */
  OPT_pass_exit_codes = 2117,                /* -pass-exit-codes */
  /* OPT_pedantic = 2118, */                 /* -pedantic */
  OPT_pedantic_errors = 2119,                /* -pedantic-errors */
  OPT_pg = 2120,                             /* -pg */
  OPT_pie = 2121,                            /* -pie */
  OPT_pipe = 2122,                           /* -pipe */
  OPT_print_file_name_ = 2123,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2124,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2125,          /* -print-multi-directory */
  OPT_print_multi_lib = 2126,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2127,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2128,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2129,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2130,               /* -print-prog-name= */
  OPT_print_search_dirs = 2131,              /* -print-search-dirs */
  OPT_print_sysroot = 2132,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2133,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2134,                    /* -print-value */
  OPT_quiet = 2135,                          /* -quiet */
  OPT_r = 2136,                              /* -r */
  OPT_remap = 2137,                          /* -remap */
  OPT_reverse_sort = 2138,                   /* -reverse-sort */
  OPT_s = 2139,                              /* -s */
  OPT_save_temps = 2140,                     /* -save-temps */
  OPT_save_temps_ = 2141,                    /* -save-temps= */
  OPT_shared = 2142,                         /* -shared */
  OPT_shared_libgcc = 2143,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2144,               /* -shared-libphobos */
  OPT_size_sort = 2145,                      /* -size-sort */
  /* OPT_specs = 2146, */                    /* -specs */
  OPT_specs_ = 2147,                         /* -specs= */
  OPT_static = 2148,                         /* -static */
  OPT_static_libasan = 2149,                 /* -static-libasan */
  OPT_static_libgcc = 2150,                  /* -static-libgcc */
  OPT_static_libgfortran = 2151,             /* -static-libgfortran */
  OPT_static_libgm2 = 2152,                  /* -static-libgm2 */
  OPT_static_libgo = 2153,                   /* -static-libgo */
  OPT_static_libhwasan = 2154,               /* -static-libhwasan */
  OPT_static_liblsan = 2155,                 /* -static-liblsan */
  OPT_static_libmpx = 2156,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2157,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2158,               /* -static-libphobos */
  OPT_static_libquadmath = 2159,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2160,               /* -static-libstdc++ */
  OPT_static_libtsan = 2161,                 /* -static-libtsan */
  OPT_static_libubsan = 2162,                /* -static-libubsan */
  OPT_static_pie = 2163,                     /* -static-pie */
  /* OPT_std_c__03 = 2164, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2165, */                /* -std=c++0x */
  OPT_std_c__11 = 2166,                      /* -std=c++11 */
  OPT_std_c__14 = 2167,                      /* -std=c++14 */
  OPT_std_c__17 = 2168,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2169, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2170, */                /* -std=c++1z */
  OPT_std_c__20 = 2171,                      /* -std=c++20 */
  OPT_std_c__23 = 2172,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2173, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2174, */                /* -std=c++2b */
  OPT_std_c__98 = 2175,                      /* -std=c++98 */
  OPT_std_c11 = 2176,                        /* -std=c11 */
  OPT_std_c17 = 2177,                        /* -std=c17 */
  /* OPT_std_c18 = 2178, */                  /* -std=c18 */
  /* OPT_std_c1x = 2179, */                  /* -std=c1x */
  OPT_std_c2x = 2180,                        /* -std=c2x */
  /* OPT_std_c89 = 2181, */                  /* -std=c89 */
  OPT_std_c90 = 2182,                        /* -std=c90 */
  OPT_std_c99 = 2183,                        /* -std=c99 */
  /* OPT_std_c9x = 2184, */                  /* -std=c9x */
  OPT_std_f2003 = 2185,                      /* -std=f2003 */
  OPT_std_f2008 = 2186,                      /* -std=f2008 */
  OPT_std_f2008ts = 2187,                    /* -std=f2008ts */
  OPT_std_f2018 = 2188,                      /* -std=f2018 */
  OPT_std_f95 = 2189,                        /* -std=f95 */
  OPT_std_gnu = 2190,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2191, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2192, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2193,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2194,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2195,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2196, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2197, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2198,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2199,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2200, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2201, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2202,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2203,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2204,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2205, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2206, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2207,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2208, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2209,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2210,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2211, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2212, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2213,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2214, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2215, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2216, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2217, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2218, */         /* -std=iso9899:2018 */
  ...
  OPT_type_stats = 2230,                     /* -type-stats */
  OPT_u = 2231,                              /* -u */
  OPT_undef = 2232,                          /* -undef */
  OPT_v = 2233,                              /* -v */
  OPT_version = 2234,                        /* -version */
  OPT_w = 2235,                              /* -w */
  OPT_wrapper = 2236,                        /* -wrapper */
  OPT_x = 2237,                              /* -x */
  OPT_z = 2238,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
